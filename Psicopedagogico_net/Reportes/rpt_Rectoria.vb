...
Public Class rpt_Rectoria
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Psicopedagogico_net.rpt_Rectoria.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Rectoria
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Rectoria = New rpt_Rectoria()
        rpt.Site = Me.Site
        Return rpt
    End Function

...
Public Class rpt_InfoAlumno
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Psicopedagogico_net.rpt_InfoAlumno.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_InfoAlumno
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_InfoAlumno = New rpt_InfoAlumno()
        rpt.Site = Me.Site
        Return rpt
    End Function

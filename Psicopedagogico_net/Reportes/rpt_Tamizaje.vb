...
Public Class rpt_Tamizaje
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Psicopedagogico_net.rpt_Tamizaje.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Tamizaje
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Tamizaje = New rpt_Tamizaje()
        rpt.Site = Me.Site
        Return rpt
    End Function

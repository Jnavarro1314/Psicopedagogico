...
Public Class rpt_Graficos_Barra
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Psicopedagogico_net.rpt_Graficos_Barra.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class Cachedrpt_Graficos_Barra
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rpt_Graficos_Barra = New rpt_Graficos_Barra()
        rpt.Site = Me.Site
        Return rpt
    End Function
